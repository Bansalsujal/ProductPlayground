...
export default function ProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsSaving(true);
    try {
      console.log('Saving profile with career stage:', careerStage);
      ...
      // Force a page reload to refresh user data in Layout context
      setTimeout(() => {
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Select value={careerStage} onValueChange={(value) => {
                  console.log('Career stage selected:', value);
                  setCareerStage(value);
                }} required>
                  <SelectTrigger>
                    <SelectValue placeholder="Select your current role level">
                      {careerStage ? careerStages.find(stage => stage.value === careerStage)?.label : null}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
